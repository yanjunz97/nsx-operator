...
const (
	...
	TagScopeLbvsType                   string = "nsx-op/lb_vs_type"
	TagValueLbvsTypeL4service          string = "layer_4"
	TagScopeServiceUid                 string = "nsx-op/service_uid"
	TagScopeCreatedFor                 string = "nsx-op/created_for"
	TagValueSLB                        string = "SLB"
	TagValueCrdSLB                     string = "CRD_LB"
	TagScopeExternalId                 string = "external_id"
	TagScopeIpPoolId                   string = "nsx-op/ip_pool_id"
	AnnotationCrdLb                    string = "nsx-op/crd_lb"
