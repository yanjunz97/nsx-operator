...
func (r *PodReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !podIsDeleted(pod) {
		...
		if r.restoreMode {
			// Add restore annotation on Pod to notity Spherelet
			retry.OnError(util.K8sClientRetry, func(err error) bool {
				return err != nil
			}, func() error {
				return common.UpdateRestoreAnnotation(r.Client, ctx, pod, "eth0")
			})
		}
	} else {
...
func (r *PodReconciler) getSubnetByIP(pod *v1.Pod, subnetSetUID string) (string, error) {
